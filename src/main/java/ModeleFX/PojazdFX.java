...
public class PojazdFX {
    ...
    public void setAmortyzacja(String Amortyzacja) {
        this.Amortyzacja.set(Amortyzacja);
    }
    public void setPodatekSrodki(String PodatekSrodki) {
        this.PodatekSrodki.set(PodatekSrodki);
    }
    ...
    public void setFirmaProperty(ObjectProperty<FirmaFX> Firma) {
        this.Firma = Firma;
    }
    
    public void setFirmaFX(FirmaFX Firma){
        this.Firma.set(Firma);
    }
    public void setIDFX(int id){
        this.id.set(id);
    }
    public void setTypPojazduFX(TypPojazduFX TypPojazdu){
        this.TypPojazdu.set(TypPojazdu);
    }

    public ObjectProperty<TypPojazduFX> getTypPojazduProperty() {
        return TypPojazdu;
    }
    ...
    public SimpleStringProperty getNumerRejestracyjnyProperty() {
        return numerRejestracyjny;
    }

    public void setNumerRejestracyjny(SimpleStringProperty numerRejestracyjny) {
    ...
    public FirmaFX getFirma(){
        return Firma.get();
    }
    public TypPojazduFX getTypPojazdu(){
    ...
    public void setLeasing(SimpleStringProperty Leasing) {
        this.Leasing = Leasing;
    }

    public SimpleStringProperty getAmortyzacjaProperty() {
        return Amortyzacja;
    }

    public void setAmortyzacja(SimpleStringProperty Amortyzacja) {
        this.Amortyzacja = Amortyzacja;
    }

    public SimpleStringProperty getPodatekSrodkiProperty() {
        return PodatekSrodki;
    }

    public void setPodatekSrodki(SimpleStringProperty PodatekSrodki) {
